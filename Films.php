...
<head>
    <title>SLStudio | See All Films</title>
...
<body>
    <div class="container-fluid bg-dark text-light">
        <div class="row">
            ...
            <h1 class="text-center fw-bold">Films</h1>
            <hr>

            <div class="col-12">
                <div class="row">
                    <div class="offset-0 offset-lg-2 col-12 col-lg-6 mb-3">
                        <input type="text" class="form-control" id="filmsearch" aria-label="Text input with dropdown button" onkeyup="filmsearch();" placeholder="Search Films Here..." />
                    </div>
                    <div class="col-12 col-lg-2 d-grid mb-3">
                        <button class="btn btn-success" onclick="filmsearch();">Search</button>
                    </div>
        ...
        <div class="row mx-auto" id="product_view_div">
            ...
            $resultset = Database::search("SELECT * FROM `product` WHERE `status_id`='1' AND `category_id`='1' ORDER BY `title` ASC");
