...
<div class="row">
    <div class="offset-0 offset-lg-1 col-12 col-lg-10 text-center">
        <div class="row ">
            ...
            ?>
                <div class="card mb-3 mt-3 col-12 col-lg-6 bg-dark border-0">
                    <div class="row">
                        <div class="col-md-4 mt-4">
                            ...
                            <a href="<?php echo "singleproductview.php?id=" . ($productImage['id']); ?>" class="h-100"><img src="<?php echo $pir["code"] ?>" class="img-fluid rounded-start" alt="..."></a>
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <br />
                                <span class="card-text text-success fw-bold"><?php echo $productImage["qty"] ?></span>
...
<div class="col-12">
    <div class="row">
        <div class="offset-3 col-5 text-center">
